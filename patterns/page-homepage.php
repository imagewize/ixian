...
<div class="wp-block-group split-section__media"><!-- wp:aludra/load-waterfall {"siteUrl":"deploy · production","badge":"live in 0.9s","rowLabels":["resolve","build","test suite","artifacts","release","healthcheck","smoke tests","traffic shift"],"lcpLabel":"live 0.9s"} -->
<figure class="wp-block-aludra-load-waterfall" aria-label="Load waterfall for deploy · production: live 0.9s"><figcaption class="wf-head"><span class="wf-url">deploy · production</span><span class="wf-badge">live in 0.9s</span></figcaption><div class="wf-rows"><div class="wf-row"><span>resolve</span><div class="wf-track"><i class="wf-bar is-doc" style="left:0%;width:22%;animation-delay:0.1s"></i></div></div><div class="wf-row"><span>build</span><div class="wf-track"><i class="wf-bar is-css" style="left:22%;width:14%;animation-delay:0.25s"></i></div></div><div class="wf-row"><span>test suite</span><div class="wf-track"><i class="wf-bar is-img" style="left:26%;width:26%;animation-delay:0.4s"></i></div></div><div class="wf-row"><span>artifacts</span><div class="wf-track"><i class="wf-bar" style="left:30%;width:18%;animation-delay:0.55s"></i></div></div><div class="wf-row"><span>release</span><div class="wf-track"><i class="wf-bar" style="left:52%;width:20%;animation-delay:0.7s"></i><b class="wf-lcp" style="left:52%"><span>live 0.9s</span></b></div></div><div class="wf-row"><span>healthcheck</span><div class="wf-track"><i class="wf-bar" style="left:72%;width:12%;animation-delay:0.85s"></i></div></div><div class="wf-row"><span>smoke tests</span><div class="wf-track"><i class="wf-bar" style="left:78%;width:10%;animation-delay:1s"></i></div></div><div class="wf-row"><span>traffic shift</span><div class="wf-track"><i class="wf-bar" style="left:82%;width:9%;animation-delay:1.15s"></i></div></div></div><div class="wf-axis"><span></span><span class="wf-ticks"><span>0s</span><span>0.5s</span><span>1.0s</span><span>1.5s</span></span></div></figure>
